...
public class Fretangulo implements Class2D{
	...
	public Fretangulo(Rectangle r) {
		this.rect = r;
	}
	public Fretangulo(Rectangle r, Color lc) {
		this.rect = r;
		this.lineColor = lc;
	}
	public Fretangulo(Rectangle r, Color lc, Color c) {
		this.rect = r;
		this.lineColor = lc;
		this.color = c;
	}
